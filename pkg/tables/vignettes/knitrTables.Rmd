...
vignette: >
  ...
  %\VignetteIndexEntry{Tables in knitr}
...
This 
vignette  was built using `tables` version `r packageDescription("tables")$Version`.

# Introduction

This is a short introduction to the `tables` package.  Inspired by my 20 year old memories
...
### `as.matrix(), write.csv.tabular(), write.table.tabular()`
...
## `knitr`,  `rmarkdown` and `kableExtra` support

This vignette was originally written many years ago using `Sweave`, and is still in that format.
...
very similar to this file, or Markdown syntax using the `rmarkdown`
package.  
